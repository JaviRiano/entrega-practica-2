...
sim = None  # Variable global para el simulador físico
...
# Función para mostrar solo la simulación física de MuJoCo
def button_visualize_simulation():
    try:
...
# Botón para mostrar el gráfico de la simulación
button_graficar = ctk.CTkButton(app, text="Mostrar Gráfico", command=plot_graph)
button_graficar.grid(row=1, column=0, padx=20, pady=20)

# Botón para mostrar la simulación física
button_mostrar_simulacion = ctk.CTkButton(app, text="Mostrar Simulación Física", command=button_visualize_simulation)
button_mostrar_simulacion.grid(row=3, column=0, columnspan=2, padx=20, pady=10)
