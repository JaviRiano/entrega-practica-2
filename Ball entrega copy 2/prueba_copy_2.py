...
class simulator:
    ...
    def get_position_data(self):
        ...
        if self.body_id is not None:
            try:
                # Intentamos acceder a la posición del cuerpo a través de geom_xpos
                position = self.data.geom_xpos[self.body_id]  # Acceso a la posición del cuerpo
                ...
                # Guardamos la posición en el recorrido
                ...
                print(f"Error al obtener la posición del cuerpo: {e}")
                raise ValueError(f"Posición del cuerpo no disponible.")
    ...
    def save_trajectory_to_json(self, file_name="trajectory.json"):
        ...
        try:
            ...
            # Agregar las nuevas posiciones al archivo existente
            existing_data.extend(object_trajectory)
            ...
            object_trajectory.clear()  # Limpiamos el recorrido guardado temporalmente
