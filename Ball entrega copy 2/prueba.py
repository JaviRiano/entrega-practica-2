...
object_id = None
body_name = "sphere2"  # Cambia esto por el nombre del objeto body_id = model.body_name2id(body_name) 
...
def main():
    ...
    simulation.run()
def main2():
    simulation=simulator("Ball entrega copy\\esfera_pruebacopy .xml")
    simulation.run()
